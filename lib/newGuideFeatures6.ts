...
export const NEW_GUIDE_FEATURE_ARTICLES_6: Record<string, FeatureArticle> = {
  ...
  "feature-qualia-meinohama": {
    ...
    ranking: [
      s(1, "1軒で完結する Kitchen & Bar の業態", "創作イタリアン・バー", "姪の浜",
      ...
      s(2, "オーナーシェフによる創作イタリアンの料理", "創作イタリアン", "姪の浜",
      ...
      s(3, "100種を超える本格カクテル", "バー・カクテル", "姪の浜",
      ...
      s(5, "利用シーンと姪浜での組み合わせ方", "利用ガイド", "姪の浜",
