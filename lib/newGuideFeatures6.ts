  ...
  "new-kanagawa-weekend": {
    ...
    ranking: [
      s(1, "横浜・みなとみらい（土曜午前）", "観光・港", "みなとみらい", "初日はみなとみらいで港の景色をスタートに",
        "週末初日の朝はみなとみらいで始めるのがおすすめ。東京から電車約30分、ランドマークタワー・赤レンガ倉庫・大さん橋を歩いて港の景色を一気に体験できる。山下公園→大さん橋→赤レンガ倉庫の徒歩ルートで約2時間、海風と港の眺めで体が「旅モード」に切り替わる。桜木町駅・みなとみらい駅・元町中華街駅の3駅から動線が組みやすい。中華街でのランチを組み合わせれば、横浜エリアで半日が成立する。夕方からは鎌倉方面に移動するか、横浜で夜景を見るか選べる二段構え。",
        [IMG.minatomirai], [{ k: "最寄り駅", v: "みなとみらい駅/元町・中華街駅" }]),
      s(2, "横浜中華街（土曜ランチ）", "中華・グルメ", "横浜中華街", "みなとみらいの後は中華街でランチ。王道コース",
        "日本最大の中華街は週末ランチのハイライト。観光客が最も集中する12〜13時のピークを避けるため、11時30分到着または14時以降が現実的。食べ歩きメイン（1人2,000〜3,000円）か店内コース（1人4,000〜8,000円）かを事前に決めて入るのが効率的。東門・西門・南門・北門の4方向から入れるが、関帝廟通り・媽祖廟通り・中華街大通りで店の雰囲気が違う。元町・中華街駅徒歩5分の駅近で、横浜・鎌倉方向どちらにも電車で繋がる。金土の20時以降は夜景の中の中華街として別の魅力がある。",
        [IMG.chinatown], [{ k: "最寄り駅", v: "元町・中華街駅 徒歩5分" }, { k: "混雑", v: "土日の12〜13時はピーク。早めに入るのが賢い" }]),
      s(3, "鎌倉（土曜午後〜夕方）", "寺社・観光", "鎌倉", "横浜から電車で30分。午後の鎌倉は人が減り始める",
        "横浜から鎌倉へはJR横須賀線で約30分。観光客が集中する朝〜昼を避け、午後14時頃から動き始めると人波が落ち着く。北鎌倉→鎌倉のルートで円覚寺・建長寺・鶴岡八幡宮を参拝、その後は小町通りで食べ歩き、由比ガ浜方向への散歩動線が組める。鎌倉駅から江ノ電に乗ると約7分で長谷駅、高徳院（鎌倉大仏）と長谷寺へ徒歩アクセスできる。夕方17時頃の小町通りは観光客が引き、落ち着いて店に入れる時間帯。鎌倉駅近のホテル・旅館に宿泊する場合は、夜の鎌倉散歩も組み込める。",
        [IMG.kamakura], [{ k: "移動", v: "横浜→鎌倉 JR横須賀線 約30分" }]),
      s(4, "箱根湯本（日曜・温泉日帰り）", "温泉・リゾート", "箱根湯本", "二日目は箱根の温泉。小田原経由で行くのがおすすめ",
        "週末2日目は箱根の温泉でリフレッシュ。鎌倉から箱根湯本へは鎌倉→横浜→小田原→箱根湯本の経路で約2時間。箱根湯本の日帰り温泉施設は午前中入浴が現実的で、午後は大涌谷ロープウェイまたは芦ノ湖遊覧船で景色を楽しむ。大涌谷の硫黄地帯と富士山の組み合わせは箱根のハイライト、晴天時は富士山が見渡せる。ポーラ美術館（仙石原）で印象派絵画と森の中の建築を組み合わせるルートも人気。箱根湯本駅周辺で温泉まんじゅう・寄せ木細工などのお土産を調達して新宿方面に戻る動線。",
        [IMG.hakone], [{ k: "移動", v: "鎌倉→横浜→小田原→箱根湯本 約2時間" }, { k: "温泉", v: "訪問前に各施設の日帰り受け付けを確認" }]),
      s(5, "湘南経由の帰路（選択肢として）", "移動・海岸", "湘南（茅ヶ崎・藤沢）", "帰りは湘南海岸経由。江の島に寄り道も",
        "箱根から東京に戻る際、小田原から東海道線に乗ると湘南海岸（茅ヶ崎・藤沢）を車窓から眺められる。時間に余裕があれば藤沢で下車して江の島まで足を伸ばすこともできる（藤沢駅から江ノ電で約10分）。江の島では江島神社・シーキャンドル（展望灯台）・岩屋洞窟・しらす丼が定番。夕方の江の島から見る富士山・湘南海岸の構図は、神奈川旅行の締めとして強い。藤沢→新宿はJRで約1時間、品川→東京方向も同様の所要時間。",
    ...
    quoteCite: author,
    closing: "標準動線（1泊2日）は、【土曜】10:00みなとみらい→12:30横浜中華街ランチ→14:00鎌倉移動→14:30〜17:30鎌倉散策→鎌倉または横浜泊。【日曜】9:00箱根湯本へ移動→10:30温泉入浴→13:00大涌谷or芦ノ湖→15:00小田原→16:00湘南経由で江の島→18:30帰京。所要約2日、予算は宿泊込みで1人25,000〜45,000円が目安。「神奈川の多様性を一度に体験したい人」「東京近郊で1泊2日旅行を組みたい人」「温泉と街と海を全部入れたい人」に向く。GW・夏休み・連休は箱根湯本〜大涌谷の道路が大渋滞、ピーク日は平日にずらすか早朝出発が現実的。雨の日は箱根の屋外スポットを諦め、ポーラ美術館＋温泉中心に再編成、または横浜・鎌倉の屋内ルートで完結させる。時間がない場合（日帰り）は、横浜中華街→鎌倉散策の2エリアに絞れば10〜18時の8時間で完結できる。迷ったら、土曜は横浜＋鎌倉、日曜は箱根日帰り、というシンプルな二日プランが神奈川週末旅行の王道。なお、紹介した動線は標準的な所要時間と混雑状況に基づいているため、季節や曜日によって柔軟に組み替えるのが現実的。週末・連休のピーク時間帯（特に土日13〜16時）は主要スポットの待ち時間が10〜30分発生することがあり、事前にWEB予約・整理券・営業時間の最新情報を公式サイトで確認するのが安全。雨予報の日は屋内ルートへの切り替えを早めに決め、晴れの日は屋外スポットの夕景時間に逆算して動き出すと満足度が高い。予算は本記事で示した目安より上振れすることもあるため、当日の現金とキャッシュレス決済の両対応で備えておきたい。なお、紹介した動線は標準的な所要時間と混雑状況に基づいているため、季節や曜日によって柔軟に組み替えるのが現実的。週末・連休のピーク時間帯（特に土日13〜16時）は主要スポットの待ち時間が10〜30分発生することがあり、事前にWEB予約・整理券・営業時間の最新情報を公式サイトで確認するのが安全。雨予報の日は屋内ルートへの切り替えを早めに決め、晴れの日は屋外スポットの夕景時間に逆算して動き出すと満足度が高い。予算は本記事で示した目安より上振れすることもあるため、当日の現金とキャッシュレス決済の両対応で備えておきたい。",
  },
};
