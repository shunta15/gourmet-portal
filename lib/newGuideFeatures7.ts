...
export const NEWGUIDE7_FEATURE_ARTICLES: Record<string, FeatureArticle> = {
  ...
  "kansai-tempozan-family": {
    ...
    "lede": "天保山は、見どころが徒歩数分の範囲に集まっているエリアだ。大阪メトロ中央線・大阪港駅を出れば、海遊館も観覧車も室内のレゴ施設も観光船も、どれも徒歩で数分。施設と施設のあいだに長い歩きが挟まらないので、ぐずる前に次の楽しみへ移れるし、ベビーカーでも段取りが崩れにくい。しかも屋根のある場所が多く、外の天気に一日を握られにくい。この半日コースは、水族館・横丁ごはん・室内遊び・観覧車・港クルーズという性格の違う体験を、子どもの集中が切れる手前で次々につなぐつもりで組んだ。朝いちばんの海遊館から始めて、海の上で締めくくる順番にしてある。",
    "date": "2026-06-13",
    "reading": "約7分",
    "author": "マチノワ編集部",
