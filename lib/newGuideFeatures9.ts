...
export const NEWGUIDE9_FEATURE_ARTICLES: Record<string, FeatureArticle> = {
  ...
  "tokyo-fukagawa-walk": {
    ...
    "quoteCite": "マチノワ編集部",
    "closing": "門前仲町の駅前まで戻ると、夕方の永代通りはもう人が増えていた。仲町通りの提灯にぽつぽつ灯がともりはじめ、辰巳新道のほうから出汁と炭の匂いが流れてくる。朝に運河で見た黒い水面のことを思い出しながら、今日たどってきた道を頭のなかで巻き戻す。池の石、緑の大橋、八幡さまの石畳、線香の煙。距離にすればたいしたことのない道のりなのに、ずいぶん遠くまで来たような気がした。なお拝観時間や入園料はときどき変わるので、出かける前に各施設の公式の案内をのぞいておくと安心して歩ける。下町は、急がない人にやさしい。"
  },
  "osaka-minoo-falls": {
    "id": "osaka-minoo-falls",
    "no": "G9-05",
  ...
  "fukuoka-munakata-taisha": {
    ...
    "ranking": [
      ...
      },
      {
        ...
        "desc": "宗像盆地をゆるやかに横切る釣川は、城山あたりに源を発して北西へ十六キロほど下り、神湊で玄界灘に注ぐ。この川がつくった沖積地には縄文・弥生の遺跡が点々と残り、古くから人が暮らし、海と社を行き来してきた道筋でもあった。橋の上から下流を眺めると、川の先に港が、その沖に大島があり、さらに沖には見えない沖ノ島へと続いている。社で手を合わせた方角と、この川が流れていく方角は、同じ海でつながっている。",
        "images": [
