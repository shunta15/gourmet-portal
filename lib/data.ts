...
export const RESTAURANTS: Restaurant[] = [
  ...
  },
  {
    ...
    region: "osaka",
    shape: "wide",
    image: "/restaurants/r29/r29-image-1.jpg",
    heroImages: [
      "/restaurants/r29/r29-image-1.jpg",
      "/restaurants/r29/r29-image-2.jpg",
      "/restaurants/r29/r29-image-3.jpg",
      "/restaurants/r29/r29-image-4.jpg",
    ],
    gallery: [
      "/restaurants/r29/r29-image-1.jpg",
      "/restaurants/r29/r29-image-2.jpg",
      "/restaurants/r29/r29-image-3.jpg",
      "/restaurants/r29/r29-image-4.jpg",
      "/restaurants/r29/r29-image-5.jpg",
    ],
    desc: "阪神なんば線・千鳥橋駅から徒歩2〜3分。漁師経験を持つオーナーが明石方面の鮮魚を直仕入れ。釣り上げた魚の持ち込み無料調理が名物で、ふぐ料理も対応。夜の予算は¥2,000台と良コスパ。",
    address: "大阪府大阪市此花区梅香3-32-5",
    hours: "月・火・木〜日 17:00〜23:00（L.O. 23:00）",
    closed: "毎週水曜",
    seats: "35席（カウンター8席・小上がり・小個室・大個室あり）",
    budget: "夜 ￥2,000〜￥2,999",
    nearest: "阪神なんば線 千鳥橋駅 徒歩2〜3分",
    phone: "06-6461-5637",
    instagram: "https://www.instagram.com/aduma2312/",
    source: { label: "公式サイト", url: "https://umaimonoya-aduma.net/" },
    tags: ["居酒屋", "海鮮", "ふぐ", "釣り魚持ち込み", "千鳥橋", "個室", "地酒"],
    highlights: [
      "漁師経験のあるオーナーが明石方面の鮮魚を直仕入れ。旬の刺身・てっさ（ふぐ刺し）が看板",
      "釣り上げた魚の持ち込み無料調理が特徴。熟成して後日受け取りも可能",
      "釣り船チャーター事業も兼営。神戸マリーナ発・大阪湾〜淡路島方面でのフィッシングと食を一体で楽しめる",
      "個室（小個室・大個室）完備でファミリーや宴会にも対応。夜の予算¥2,000〜¥2,999",
    ],
    body: [
      "阪神なんば線・千鳥橋駅から徒歩2〜3分、此花区梅香に「旨いもの家 あづま」がある。長年漁師として活動した経験を持つオーナーが切り盛りするアットホームな居酒屋で、地元に根ざした隠れ名店として評判が高い。",
      "看板は旬の海鮮刺身。明石方面の鮮魚をオーナー自ら直仕入れし、熟成まで手がける。てっさ（ふぐ刺し）・てっちり（ふぐ鍋）も提供しており、ハマチなど地元漁場の青魚も揃う。最大の特徴は「釣り魚持ち込み無料調理」で、自分で釣った魚を店で料理してもらえる（熟成して後日受け取りも可）。",
      "店内はカウンター8席、小上がり、小個室・大個室を備え、ファミリーから常連まで幅広く対応する。夜の予算は¥2,000〜¥2,999と良コスパ。なお現金払いが基本のため来店前に確認を。釣り船チャーター（神戸マリーナ発・大阪湾〜淡路島方面）との組み合わせも楽しめる。",
    ],
  },
  {
    id: "r30",
